              ...
              <table class="table table-bordered table-striped" style='margin-top: 0px; margin-bottom: 0px;'>
                <thead>
                  <tr style='background-color: #022A33; color: white;'>
                    <th><p style="font-size: 20px; text-weight: bold; text-align: center;">Title</p></th>
                    <th><p style="font-size: 20px; text-weight: bold; text-align: center;">Post From</p></th>
                    <th><p style="font-size: 20px; text-weight: bold; text-align: center;">Category</p></th>
                    <th><p style="font-size: 20px; text-weight: bold; text-align: center;">Published On</p></th>
                  ...
                  ?>
                      <tr style='background-color: <?php echo $bc_color; ?>'>
                        <form action="viewPost.php" method='GET'>
                          <input type='hidden' name='id' value='<?php echo $p_id?>'> <!-- this input box will store the id of the customers-->
                          <td style="text-align: center;"><img src='<?php echo $img_path;?>' style="height: 40px; margin-top: 1rem; paddding: auto;" alt=""><p> <?php echo $title; ?> </p></td>
                          <td><p style="margin-top: 23px; color: black; font-size: 20px; text-weight: bold; text-align: center;"><?php echo $from;?></p></td>
                          <td><p style="margin-top: 23px; color: black; font-size: 20px; text-weight: bold; text-align: center;"><?php echo $cat;?></p></td>
                          <td><p style="margin-top: 23px; color: black; font-size: 20px; text-weight: bold; text-align: center;"><?php echo $date;?></p></td>
                          <td style="text-align: center;">
                            <input formaction='viewPost.php' type="submit" style="margin-top: 1.5rem;" class="btn btn-success btn-pill" value='Full Post'>
                          </td>
                        </form>
                      </tr>
                      <?php
