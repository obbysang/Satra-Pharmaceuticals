  ...
  <body style='background-color: #F0EEEE;'>
    ...
    <div class="main">
      ...
      <div class="card">
        ...
        <?php endif; ?>
        <h5 class="title" style='background-color: black; color: white; height: 2rem; font-size: 22px;'>ADMIN</h5>
        ...
        <h5 class="title" style='margin-top: 25px;'><?php echo"Email: $email"?></h5>
        <h5 class="title" style='margin-top: 25px;'><?php echo"Password : $pass"?></h5>
        <h5 class="title" style='margin-top: 25px;'><?php echo"Joined : 01-08-2019"?></h5>
