...
<html>
  ...
  <body style='background-color: #F0EEEE;'>
    ...
    <?php
      echo "<div class='container' style='margin-top: 7rem; border: 1px solid black;'>
                <div class='row' style='margin-top: 30px; margin-left: 20px;'>
                  <div class='col-sm-5'>
                    <img src='$row[image_dir]' style='width: 425px; height: 250px;' alt='Post Image'>
                    <h4 style='margin-top: 10px; color: red; text-align: center;'>$row[topic_name]</h4>
                    <h4>Author: $row[author_name]</h4>
                    <h4>Published: $row[published_date]</h4>
                  </div>
                  <div class='col-sm-7'>
                      <h6>
                        $row[details]
