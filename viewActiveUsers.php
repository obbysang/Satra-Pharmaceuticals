              ...
              <table class="table table-bordered table-striped" style='margin-top: 0px; margin-bottom: 0px;'>
                <thead>
                  <tr style='background-color: #022A33; color: white;'>
                    <th><p style="font-size: 20px; text-weight: bold; text-align: center;">Name</p></th>
                    <th><p style="font-size: 20px; text-weight: bold; text-align: center;">Email</p></th>
                    <th><p style="font-size: 20px; text-weight: bold; text-align: center;">Role</p></th>
                    <th><p style="font-size: 20px; text-weight: bold; text-align: center;">Order Count</p></th>
                    <th><p style="font-size: 20px; text-weight: bold; text-align: center;">Joined On</p></th>
                  ...
                  ?>
                      <tr style='background-color: <?php echo $bc_color; ?>'>
                        <form action="viewProfile.php" method='POST'>
                          ...
                          <td><p style="margin-top: 23px; color: black; font-size: 20px; text-weight: bold; text-align: center;"><?php echo $order_count;?></p></td>
                          <td><p style="margin-top: 23px; color: black; font-size: 20px; text-weight: bold; text-align: center;"><?php echo $join_date;?></p></td>
