    ...
    <body>
        ...
        <div class="container" style="margin-top: 3rem; padding: 1rem;">
            <nav class="navbar navbar-expand-md fixed-top" style="background-color: lightblue;">
                ...
                <a class="navbar-brand mr-auto" href="index.php"><img src="images/logo2.png" style='max-width: 100%; height: 5vh; margin-left: 0.5rem;'></a>
                ...
                <div class="collapse navbar-collapse" id="navbarMenu">
                    <ul class="navbar-nav mr-auto"> 
                        ...
                        <a class="navbar-brand "  style="color: navyblue; font-weight:bold; margin-left: 40px;"  >
