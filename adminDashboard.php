...
<html>
  ...
  <body style='background-color: #F0EEEE;'>
    ...
    <a id='list' type="submit" onclick='toggleDiv()'><i style="color: #3D86EC;" class="fas fa-chart-line"></i>Statistics</a>
    ...
    <div class="main">
      ...
      <div class="container-fluid" id='header'>
        <div class='left'>
          <a href="adminDashboard.php" id='p2'><i class="fas fa-newspaper" ></i>Menu</a>
          <a href="adminDashboard.php" id='aText'><i class="fas fa-newspaper" id='iLogo'></i>ADMIN DASHBOARD</a>
        </div>
        <div class='right'>
          <div class="dropdown">
    ...
    document.addEventListener("DOMContentLoaded", function() {
      ...
      function openSidebar() {
        ...
        mainContent.style.marginLeft = "170px";
      }
      ...
      // Event listener to toggle sidebar when clicked
