...
<html>
  ...
  <body style='background-color: #F0EEEE;'>
    <div class="sidenav">
      ...
      <a href="viewProducts.php" type="submit" id="list"> <i style='color: #00FFEA;' class="fas fa-store"></i>Products</a>
    ...
    <div class="main">
      ...
      <div class="container" style='margin-top: 10px; padding: 10px;'>
				...
				<p>You can view or edit products details by clicking View Details button</p>
				<div class="table-responsive">          
					<table class="table table-bordered table-striped">
						<thead>
							<tr style='background-color: #34495E; color: white;'>
								<th><h4 style="text-align: center;">Product Name</h4></th>
                <th><h4 style="text-align: center;">Product Category</h4></th>
								<th><h4 style="text-align: center;">Stock Quantity</h4></th>
                <th><h4 style="text-align: center;">Brand</h4></th>
              ...
              ?>
									<tr>
										<form action="viewProduct.php" method='POST'>
											<input type='hidden' name='id' value='<?php echo $pro_id;?>'> <!-- this input box will store the id of the customers-->
											<td style="text-align: center;"><img src='<?php echo $img_path;?>' style="height: 40px; margin-top: 1rem; paddding: auto;" alt=""><h6> <?php echo $name; ?> </h6></td>
											<td style="text-align: center;"><h5 style="margin-top: 2rem;"><?php echo $cat; ?></h5></td>
											<td style="text-align: center;"><h5 style="margin-top: 2rem;"> <?php echo $stored; ?></h5></td>
											<td style="text-align: center;"><h5 style="margin-top: 2rem;"> <?php echo $brand; ?></h5></td>
											<td style="text-align: center;">
												<input type="submit" style="margin-top: 1.5rem;" class="btn btn-success btn-pill" value='View Details'>
											</td>
										</form>
									</tr>
									<?php
