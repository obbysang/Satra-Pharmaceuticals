...
<html>
    <head>
        <title> Babycare Products Page</title>
    ...
    <body>
        ...
        <div class='container-fluid' style="margin-top: 1rem;">
            <nav aria-label='breadcrumb'>
                <ol class='breadcrumb'>
                    ...
                    <li class='breadcrumb-item active' aria-current='page'> Babycare</li>
                </ol>
            </nav>
        </div>
        ...
        <div class="container">
            <h2 class="slider-title">
                <span class="inline-title"> Babycare Products</span>
            ...
            <?php
                ...
                try {
                    ...
                    $product_query = "SELECT * FROM product WHERE pro_cat = 'babycare'";
                    ...
                    for ($i = 0; $i < count($products); $i++) {
                        ...
                        if($temp){
                                echo    "<button class='btn btn-success btn-block'>
                                        ...
                                        <form action='babycare.php' method='GET'>
                            ...
                            echo      "<form action='babycare.php' method='GET'>
