...
<html>
    <head>
        <title> Healthcare Products Page</title>
    </head>
    <body>
        ...
        <div class="container">
            <h2 class="slider-title">
                <span class="inline-title"> Healthcare Products</span>
            ...
            <?php
                ...
                try {
                    ...
                    $product_query = "SELECT * FROM product WHERE pro_cat = 'healthcare'";
                    ...
                    for ($i = 0; $i < count($products); $i++) {
                        ...
                        if($temp){
                                echo    "<button class='btn btn-success btn-block'>
                                        ...
                                        <form action='healthcare_cart.php' method='GET'>
                            ...
                            echo      "<form action='healthcare_cart.php' method='GET'>
			...
			<div class='container'>
				<div class='row'>             
					<div class='col-sm-6'>
						...
						<i class='fas fa-at fa-lg' class='font_awsome'></i> &nbsp; &nbsp;  obbysang51@gmail.com<br>
					</div>
