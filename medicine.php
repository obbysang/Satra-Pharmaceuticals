...
<html>
    <head>
        <title>Medicine Product Page</title>
    </head>
    <body>
        ...
        <div class="container">
            <h2 class="slider-title">
                <span class="inline-title">Medicine Products</span>
            ...
            <?php
                ...
                try {
                    ...
                    $product_query = "SELECT * FROM product WHERE pro_cat = 'medicine'";
                    ...
                    for ($i = 0; $i < count($products); $i++) {
                        ...
                        if($temp){
                            ...
                            echo      "<form action='medicine.php' method='GET'>
