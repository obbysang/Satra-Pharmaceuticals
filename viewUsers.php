  ...
  <body style='background-color: #F0EEEE;'>
    ...
    <div class="main">
      ...
      <div class="container" style='margin-top: 10px; padding: 10px;'>
        <br>
				<h2>Users Table</h2>
				<p>You can view or edit users details by clicking View Details button</p>
                ...
                $sql = "SELECT * FROM user_table WHERE user_cat = 'user' or user_cat = 'customer' or user_cat = 'Customer'";
