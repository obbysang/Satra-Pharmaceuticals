...
<html>
  ...
  <body style='background-color: #F0EEEE;'>
    ...
    <div class="main">
      ...
      <div class="container" style='margin: 20px 0px 10px 25px; padding: 10px;'>
        <div class="row">
          <div class="col-md-4" style="border: 1px solid black;">
            <h5 class="bx_title" style="background: black; color: white; text-align: center;"> Total Users</h5>
            ...
            <div>
              <h5 style=""><a href='viewUsers.php'>View All...</a></h5>
            </div>
            
          </div>
          
          <div class="col-md-4" style="border: 1px solid black;">
            <h5 class="bx_title"> Total Products</h5>
            <i class="fas fa-shopping-cart" id="i2"></i>
            <h1><?php echo $count_product; ?> </h1>
            <h5><a href='viewProducts.php'>View All...</a></h5>
          </div>
          
          <div class="col-md-4" style="border: 1px solid black;">
            <h5 class="bx_title"> Total Posts</h5>
            <i class="fas fa-pen-nib" id="i3"></i>
            <h1><?php echo $count_post; ?> </h1>
            <h5><a href='viewPosts.php'>View All...</a></h5>
          </div>
        </div>
      </div>
